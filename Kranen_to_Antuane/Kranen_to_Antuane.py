...
# Формула Kranen-Nes
# P = 100 * 10^(3.2041 * (1 - 0.998 * ((Tb - 41) / (T + 273.15 - 41)) * ((1393 - T - 273.15) / (1393 - Tb))))
def kranen_nes(T, Tb):
...
Tb = 78.23+273.15 # Температура кипения, °C->K
T_range = np.linspace(-100, 500, 100)  # Диапазон температур, °C
P_data = kranen_nes(T_range, Tb)  # Давления, рассчитанные по Kranen-Nes
